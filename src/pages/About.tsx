      ...
      <div className="mx-auto w-full max-w-6xl px-4 pb-20 pt-32 md:px-6">
        ...
        >
          ...
          <motion.h1
            ...
            className="mb-6 text-4xl font-serif font-medium leading-tight text-foreground sm:text-5xl lg:text-[4.4rem]"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="mx-auto max-w-2xl text-base font-light leading-8 text-muted-foreground sm:text-lg lg:text-xl"
          >
        ...
        <div className="mb-28 grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-14">
          ...
          >
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-2 md:-right-6 bg-white/80 dark:bg-black/80 backdrop-blur-xl border border-white/20 p-4 md:p-6 rounded-2xl shadow-xl max-w-[80%] md:max-w-xs block">
          ...
          >
            ...
            <div className="pt-4">
              <Button
                variant="outline"
                className="rounded-full px-8 h-12 border-foreground/20 hover:bg-foreground hover:text-background transition-all"
              >
                Meet the Artists
              </Button>
            </div>
        ...
        <div className="relative rounded-[3rem] overflow-hidden h-[400px] flex items-center justify-center text-center px-4">
          ...
          >
            ...
            <Button
              asChild
              size="lg"
              className="rounded-full h-14 px-10 bg-white text-black hover:bg-white/90 text-lg"
            >
              <Link to="/gallery">
