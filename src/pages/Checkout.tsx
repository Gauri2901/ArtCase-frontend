...
const Checkout = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    // 'values' is an object with all our form data
    ...
    // Clear the cart
    // We need to add 'clearCart' to our context! (We'll do that next)
    clearCart(); 
    
    // We would also redirect the user, e.g., to a "Thank You" page
    // navigate("/thank-you");
  }
