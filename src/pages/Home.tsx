    ...
    <section ref={ref} className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-20 lg:py-0 lg:h-screen">
        ...
        <div className="hidden lg:block relative h-[600px] w-full">
          ...
          >
            <img src={CLOUDINARY_IMAGES[2]} alt="Forest" className="w-full h-full object-cover scale-110" />
          </motion.div>
        </div>
        ...
        <div className="lg:hidden flex flex-col gap-6">
          ...
          >
            ...
            >
              <img src={CLOUDINARY_IMAGES[2]} alt="Painting" className="w-full h-full object-cover scale-110" />
            </motion.div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
    ...
    <section className="py-32 bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative h-[600px] w-full bg-neutral-800 rounded-2xl overflow-hidden border border-white/10 group cursor-pointer">
          ...
          <img src={CLOUDINARY_IMAGES[9]} alt="In the Studio" className="h-full w-full object-cover opacity-60 scale-105 group-hover:scale-100 transition-transform duration-700" />
            ...
            <div className="relative h-[420px] md:h-[520px] flex items-center justify-center">
              ...
              >
                <div className="w-full h-full bg-gray-100 overflow-hidden relative">
                  <img src={CLOUDINARY_IMAGES[10]} className="w-full h-full object-cover" />
